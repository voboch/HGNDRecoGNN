...
\begin{enumerate}
  \item \textbf{Cross-dataset feature-scaler drift.}
    ...
    Impact on the closure metric: \TODO{quote from full run}.
    Mitigation: refit a global scaler on the pooled datasets and
    re-evaluate; report both closure values.

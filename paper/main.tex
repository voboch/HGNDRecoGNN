...
$\varepsilon_{\text{cl}} = 0.735$ and $\varepsilon_{\text{ev}} = 0.841$,
...
\begin{table}[!t]
  ...
  \caption{Cluster-level neutron detection efficiency at the
    purity-locked operating point ($t \approx 0.31$, $\pi = 0.706$),
    HPC checkpoint on the \texttt{defaultSpot} test split. The
